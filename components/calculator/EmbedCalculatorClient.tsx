...
export default function EmbedCalculatorClient() {
  ...
  const generateScenarioName = (company: string) => {
    ...
    const version = prospectiveHistory.length + 1
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 to-white p-4">
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div className="mb-6 text-center">
          ...
          <p className="text-neutral-600">
            Calculate your marketing ROI and explore prospective scenarios
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr_2fr] gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-neutral-200">
            ...
            <form onSubmit={currentForm.handleSubmit(handleStep1Submit)} className="space-y-4">
              {/* Company Name */}
              <div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <label className={`flex items-center justify-center px-3 py-2 border-2 rounded-lg cursor-pointer transition ${
                    timePeriod === 'weekly'
              ...
              <button
                type="submit"
                className="w-full px-6 py-3 bg-brand-primary text-white rounded-lg hover:bg-brand-hover transition font-medium flex items-center justify-center text-sm"
              >
          ...
          <div className={`bg-white rounded-2xl shadow-lg p-6 border border-neutral-200 transition-opacity ${
            ...
            {showScenarioForm && currentMetrics ? (
              <form onSubmit={scenarioForm.handleSubmit(handleStep2Submit)} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-brand-secondary focus:border-transparent outline-none transition bg-neutral-50 text-sm"
                ...
                {enableAdjustments && (
                  <div className="space-y-3 p-4 bg-brand-secondary/5 border border-brand-secondary/20 rounded-lg">
                    <div>
                      <label className="block text-sm font-medium text-neutral-700 mb-2">
                ...
                <button
                  type="submit"
                  className="w-full px-6 py-3 bg-brand-secondary text-white rounded-lg hover:bg-purple-700 transition font-medium flex items-center justify-center text-sm"
                >
            ...
            {currentMetrics && (
              <>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-4 border border-neutral-200">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    {prospectiveHistory.length > 0 && (
                      <button
                        ...
                        className="px-3 py-1 bg-yellow-400 hover:bg-yellow-500 text-neutral-900 text-xs font-medium rounded transition"
                      >
                        Clear
                      </button>
                    )}
                  ...
                  <div className="grid grid-cols-7 gap-2">
                    <div className="p-2 bg-neutral-100 rounded-lg">
                      ...
                      <p className="text-sm font-bold text-neutral-900">{currentMetrics.current_leads.toLocaleString()}</p>
                    </div>
                    <div className="p-2 bg-neutral-100 rounded-lg">
                      <p className="text-xs text-neutral-600 mb-1">Sales</p>
                      <p className="text-sm font-bold text-neutral-900">{currentMetrics.current_sales.toLocaleString()}</p>
                    </div>
                    <div className="p-2 bg-neutral-100 rounded-lg">
                      <p className="text-xs text-neutral-600 mb-1">Ad Spend</p>
                      <p className="text-sm font-bold text-neutral-900">{formatNumber(currentMetrics.current_ad_spend)}</p>
                    </div>
                    <div className="p-2 bg-neutral-100 rounded-lg">
                      <p className="text-xs text-neutral-600 mb-1">Revenue</p>
                      <p className="text-sm font-bold text-neutral-900">{formatNumber(currentMetrics.current_revenue)}</p>
                    </div>
                ...
                {prospectiveHistory.map((metrics, index) => (
                  <div key={index} className="bg-white rounded-2xl shadow-lg p-4 border border-success">
                    <h3 className="text-lg font-bold text-success-dark mb-3">
                    ...
                    <div className="grid grid-cols-7 gap-2">
                      <div className="p-2 bg-success/10 rounded-lg">
                        ...
                        <p className="text-sm font-bold text-success-dark">{metrics.leads.toLocaleString()}</p>
                      </div>
                      <div className="p-2 bg-success/10 rounded-lg">
                        <p className="text-xs text-success-dark mb-1">Sales</p>
                        <p className="text-sm font-bold text-success-dark">{metrics.sales.toLocaleString()}</p>
                      </div>
                      <div className="p-2 bg-success/10 rounded-lg">
                        <p className="text-xs text-success-dark mb-1">Ad Spend</p>
                        <p className="text-sm font-bold text-success-dark">{formatNumber(metrics.adSpend)}</p>
                      </div>
                      <div className="p-2 bg-success/10 rounded-lg">
                        <p className="text-xs text-success-dark mb-1">Revenue</p>
                        <p className="text-sm font-bold text-success-dark">{formatNumber(metrics.revenue)}</p>
                      </div>
