...
async function applyMigration() {
  try {
    const migration = fs.readFileSync('./supabase/migrations/20251118000001_add_legal_company_name_to_brands.sql', 'utf8')
    ...
    console.log('Added legal_company_name column to brands table')
  } catch (err) {
